...
#[cfg(target_arch = "xtensa")]
pub use board::{
    HardwareDiagnosticReport, run_failure_diagnostic, run_hardware_diagnostics,
    run_rtc_alarm_assertion_diagnostic, run_sleep_diagnostic, run_timer_sleep_diagnostic,
...
pub use protocol::{ProtocolAction, ProtocolOutcome, handle_protocol_request};
