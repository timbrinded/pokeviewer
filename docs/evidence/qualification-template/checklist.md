...
- [ ] Settled deep-sleep current is at most 0.500 mA.
- [ ] Boot-to-sleep active duration is at most 30 seconds.
- [ ] Intended protected-cell capacity meets the calculated 72-hour minimum.
