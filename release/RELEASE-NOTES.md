...
Publication requires the v1.1.0 device qualification and exact-artifact
clean-host rehearsal to pass. Physical images remain private. Public evidence
states only that reviewed images were provided.
