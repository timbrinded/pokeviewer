...
The firmware implements the ESP-IDF-aligned RTC wake and deep-sleep path, but
physical current measurements, the unattended run, and exact-artifact
rehearsal remain unqualified.
